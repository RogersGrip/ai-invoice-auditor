...
from src.core.llm_wrapper import BedrockCommandRPlus
from src.core.config import settings
from src.core.logger import logger

class MLflowEvaluator:
    """
    Fallback evaluator mimicking MLflow's GenAI metrics using standard prompts.
    Used when Ragas fails.
    """
    
    def __init__(self):
        # Use our custom wrapper which we know works
    ...
    def evaluate(self, query: str, answer: str, context: str) -> Dict[str, Any]:
        ...
        You are an expert evaluator. Rate the faithfulness of the answer to the context on a scale of 0.0 to 1.0.
        Context: {context}
        Answer: {answer}
        ...
        relevance_prompt = f"""
        You are an expert evaluator. Rate the relevance of the answer to the query on a scale of 0.0 to 1.0.
        Query: {query}
        Answer: {answer}

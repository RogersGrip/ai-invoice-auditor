...
class LangBridgeTool(BaseTool):
    def __init__(self):
        super().__init__(
            ...
            description="Standardizes invoice content to English JSON format with full translation."
        )
    ...
    def run(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            prompt = PromptTemplate(
                template="""You are an expert invoice data extraction and translation system.
